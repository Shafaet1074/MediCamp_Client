...
const Doctor = ({doctor}) => {
  ...
  return (
    <div className="max-w-md p-8 sm:flex sm:space-x-6  border-2 border-cyan-300 bg-cyan-200">
    <div className="flex-shrink-0 w-full mb-6 h-44 sm:h-32 sm:w-32 sm:mb-0">
      <img src={doctor.image_url} alt="" className="object-cover object-center w-full h-full rounded dark:bg-gray-500" />
    </div>
